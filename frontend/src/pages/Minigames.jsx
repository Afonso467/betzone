...
const GAMES = [
  ...
  { path: '/dice',      icon: '🎲', title: 'Dice',          desc: 'Escolhe o teu alvo e aposta se o dado vai ficar acima ou abaixo. Odds em tempo real!',    color: '#f59e0b' },
  { path: '/plinko',    icon: '🪂', title: 'Plinko',        desc: 'Deixa a bola cair pelos pinos. Quanto mais arriscado, maior o multiplicador!',            color: '#8b5cf6' },
  { path: '/poker',     icon: '🂡', title: 'Vídeo Poker',   desc: 'Jacks or Better. Descarta e troca cartas para formar a melhor mão possível!',             color: '#10b981' },
  { path: '/slots',     icon: '🎰', title: 'Slots',         desc: 'Máquina clássica com 9 símbolos. Lucky 7 paga 250x. Testa a tua sorte!',                  color: '#f97316' },
